...
func newTestDeviceRedisClient(t *testing.T) (*miniredis.Miniredis, redis.UniversalClient) {
	t.Helper()
	mr := miniredis.RunT(t)
...
func TestRedisDeviceStore_ImplementsInterface(t *testing.T) {
	var _ device.Store = (*RedisDeviceStore)(nil)
}

func TestRedisDeviceStore_New(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)

	t.Run("defaults", func(t *testing.T) {
		s := NewRedisDeviceStore(client)
		assert.NotNil(t, s)
	...
	t.Run("custom options", func(t *testing.T) {
		...
		assert.Equal(t, "app:", s.prefix)
	})
}

func TestRedisDeviceStore_AddDevice(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
...
func TestRedisDeviceStore_AddDevice_KickOldest(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
...
func TestRedisDeviceStore_AddDevice_MultipleKick(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
...
func TestRedisDeviceStore_CheckDevice(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
...
func TestRedisDeviceStore_RemoveDevice(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
...
func TestRedisDeviceStore_RemoveDevice_NonExist(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
...
func TestRedisDeviceStore_RemoveAllDevices(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
...
func TestRedisDeviceStore_RemoveAllDevices_NoDevices(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
...
func TestRedisDeviceStore_ListDevices(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
...
func TestRedisDeviceStore_CrossUserIsolation(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
...
func TestRedisDeviceStore_AddDevice_KickWithZeroMax(t *testing.T) {
	_, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client)
	...
	// maxDevices=0 表示不限制。
	for i := 0; i < 10; i++ {
		kicked, err := s.AddDevice(ctx, "user-1", "dev-"+string(rune('a'+i)), "jti-"+string(rune('a'+i)), 0)
		require.NoError(t, err)
		assert.Empty(t, kicked)
	}
...
func TestRedisDeviceStore_WithKeyPrefix(t *testing.T) {
	mr, client := newTestDeviceRedisClient(t)
	ctx := context.Background()
	s := NewRedisDeviceStore(client, WithKeyPrefix("app:"))

	_, err := s.AddDevice(ctx, "user-1", "dev-1", "jti-1", 5)
	require.NoError(t, err)

	keys := mr.Keys()
	assert.Contains(t, keys, "app:device:user-1")
