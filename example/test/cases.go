...
func allCases() []TestCase {
	return []TestCase{
		...
		// ── Middleware (skip in local mode) ──
		{
			...
			Assert:   and(statusCode(200), dataFieldHas("key", "value", "get_value")),
			Category: "middleware",
		...
		},
		{
			...
			Assert:   and(statusCode(200), dataFieldHas("key", "sent")),
			Category: "middleware",
		...
		},
		{
			...
			Method:   "GET",
			Path:     "/middleware/db",
			Assert:   and(statusCode(200), dataFieldHas("ping", "healthy")),
			Category: "middleware",
		...
		},
		{
			...
			Method:   "GET",
			Path:     "/middleware/es",
			Assert:   and(statusCode(200), dataFieldHas("status_code", "body")),
			Category: "middleware",
		...
		},
		{
			...
			Assert:   and(statusCode(200), dataFieldHas("result")),
			Category: "middleware",
